  ...
  constructor() {
    ...
    this.state = {
      ...
      data: [
        {
          price: 40,
          image: require("../images/shoes/1.jpg")
        },
        {
          price: 30,
          image: require("../images/shoes/2.jpg")
        },
        {
          price: 50,
        ...
        {
          price: 90,
          image: require("../images/shoes/4.jpg")
        },
        {
          price: 70,
          image: require("../images/shoes/5.jpg")
        },
        {
          price: 200,
          image: require("../images/shoes/6.jpg")
        },
        {
          price: 140,
          image: require("../images/shoes/7.jpg")
        },
        {
          price: 40,
          image: require("../images/shoes/8.jpg")
        },
        {
          price: 120,
          image: require("../images/shoes/9.jpg")
        }
      ]
    };
