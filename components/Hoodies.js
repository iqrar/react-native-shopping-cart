  ...
  constructor() {
    ...
    this.state = {
      ...
      data: [
        {
          price: 40,
          image: require("../images/hoodies/1.jpg")
        },
        {
          price: 30,
          image: require("../images/hoodies/2.jpg")
        },
        {
          price: 50,
          image: require("../images/hoodies/3.jpg")
        },
        {
          price: 90,
          image: require("../images/hoodies/4.jpg")
        },
        {
          price: 70,
          image: require("../images/hoodies/5.jpg")
        },
        {
          price: 200,
          image: require("../images/hoodies/10.jpg")
        },
        {
          price: 140,
          image: require("../images/hoodies/7.jpg")
        },
        {
          price: 40,
          image: require("../images/hoodies/8.jpg")
        },
        {
          price: 120,
          image: require("../images/hoodies/9.jpg")
        }
      ]
    };
