  ...
  constructor() {
    ...
    this.state = {
      ...
      data: [
        {
          price: 40,
          image: require("../images/jackets/1.jpg")
        },
        {
          price: 30,
          image: require("../images/jackets/2.jpg")
        },
        {
          price: 50,
          image: require("../images/jackets/3.jpg")
        },
        {
          price: 90,
          image: require("../images/jackets/4.jpg")
        },
        {
          price: 70,
          image: require("../images/jackets/5.jpg")
        },
        {
          price: 200,
          image: require("../images/jackets/10.jpg")
        },
        {
          price: 140,
          image: require("../images/jackets/7.jpg")
        },
        {
          price: 40,
          image: require("../images/jackets/8.jpg")
        },
        {
          price: 120,
          image: require("../images/jackets/9.jpg")
        }
      ]
    };
