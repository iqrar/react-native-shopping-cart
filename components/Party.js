  ...
  constructor() {
   ...
   this.state = {
      ...
      data: [
        {
          price: 40,
          image: require("../images/party/1.jpg")
        },
        {
          price: 30,
          image: require("../images/party/2.jpg")
        },
        {
          price: 50,
          image: require("../images/party/3.jpg")
        },
        {
          price: 90,
          image: require("../images/party/4.jpg")
        },
        {
          price: 70,
          image: require("../images/party/5.jpg")
        },
        {
          price: 200,
          image: require("../images/party/6.jpg")
        },
        {
          price: 140,
          image: require("../images/party/7.jpg")
        },
        {
          price: 40,
          image: require("../images/party/8.jpg")
        },
        {
          price: 120,
          image: require("../images/party/9.jpg")
        }
      ]
    };
