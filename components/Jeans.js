  ...
  constructor() {
    ...
    this.state = {
      ...
      data: [
        {
          price: 40,
          image: require("../images/jeans/1.jpg")
        },
        {
          price: 30,
          image: require("../images/jeans/2.jpg")
        },
        {
          price: 50,
          image: require("../images/jeans/3.jpg")
        },
        {
          price: 90,
          image: require("../images/jeans/4.jpg")
        },
        {
          price: 70,
          image: require("../images/jeans/5.jpg")
        },
        {
          price: 200,
          image: require("../images/jeans/6.jpg")
        },
        {
          price: 140,
          image: require("../images/jeans/7.jpg")
        },
        {
          price: 40,
          image: require("../images/jeans/8.jpg")
        },
        {
          price: 120,
          image: require("../images/jeans/9.jpg")
        }
      ]
    };
