    ...
    super();
     this.state = {
      ...
      data: [
        {
          price: 40,
          image: require("../images/shirt/1.jpg")
        },
        {
          price: 30,
          image: require("../images/shirt/2.jpg")
        },
        {
          price: 50,
          image: require("../images/shirt/3.jpg")
        },
        {
          price: 90,
          image: require("../images/shirt/4.jpg")
        },
        {
          price: 70,
          image: require("../images/shirt/5.jpg")
        },
        {
          price: 200,
          image: require("../images/shirt/6.jpg")
        },
        {
          price: 140,
          image: require("../images/shirt/7.jpg")
        },
        {
          price: 40,
          image: require("../images/shirt/8.jpg")
        },
        {
          price: 120,
          image: require("../images/shirt/9.jpg")
        }
      ]
    };
